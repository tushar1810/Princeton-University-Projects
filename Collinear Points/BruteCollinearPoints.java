...
//             }
//         }
//         ArrayList<LineSegment> lis = new ArrayList<LineSegment>();
//         // LineSegment arr[];
...
//             }
//         }
//         for (int i = 0; i < pointss.length - 3; i++) {
//             for (int j = i + 1; j < pointss.length - 2; j++) {
//                 for (int k = j + 1; k < pointss.length - 1; k++) {
//                     for (int m = k + 1; m < pointss.length; m++) {
//                         double s = pointss[i].slopeTo(pointss[j]);
//                         if (s == pointss[i].slopeTo(pointss[k]) && s == pointss[i]
//                                 .slopeTo(pointss[m])) {
//
//                             LineSegment temp = new LineSegment(pointss[i], pointss[m]);
...
//             }
//         }
//         arr = lis.toArray(new LineSegment[lis.size()]);
//
//     }
